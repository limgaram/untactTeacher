		...
		<form onsubmit="MemberModify__checkAndSubmit(this); return false;" action="doModify" method="POST">
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input type="password" name="loginPW" autofocus="autofocus" class="form-row-input w-full rounded-sm" placeholder="로그인비밀번호를 입력해주세요.">
				</div>
			</div>
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input type="password" name="loginPWConfirm" autofocus="autofocus" class="form-row-input w-full rounded-sm" placeholder="로그인비밀번호확인을 입력해주세요.">
				</div>
			</div>
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${member.nickname}" type="text" name="nickname" autofocus="autofocus" class="form-row-input w-full rounded-sm" placeholder="닉네임을 입력해주세요.">
				</div>
			</div>
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<input value="${member.cellphoneNo}" type="cellphoneNo" name="cellphoneNo" autofocus="autofocus" class="form-row-input w-full rounded-sm" placeholder="전화번호를 입력해주세요.">
				</div>
			</div>
			...
			<div class="form-row flex flex-col lg:flex-row">
				...
				<div class="lg:flex-grow">
					<div class="btns">
						...
						<input onclick="history.back();" type="button" class="btn-info bg-red-500 hover:bg-red-dark text-white font-bold py-2 px-4 rounded" value="최소" />
